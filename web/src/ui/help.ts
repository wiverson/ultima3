...
export const KEYBOARD_HELP: string[][] = [
  [
    ...
    '1 3 7 9    walk diagonally (if allowed)',
    'Space      pass a turn',
  ...
  [
    ...
    '',
    'A green L! by a name: Lord British',
    'will raise that member.',
    '',
    'P poisoned  D dead  A ashes',
    '',
...
export const CONTROLLER_HELP: string[][] = [
  [
    ...
    'C = X             V = Y',
    '',
    'The command menu lists what your',
    'surroundings call for first: Enter',
    'on a town, Board on a horse, Get on',
    'a chest, Attack beside a monster.',
  ...
  [
    ...
    'P poisoned  D dead  A ashes',
    '',
    'Numbers use a spinner, names an',
    'on-screen keyboard.',
    '',
